hook.Add("DrG/LoadLanguages", "DrG/FrenchLanguage", function()
  ...
  lang:Set("tool.drgbase_tool_damage.true", "Oui")
  lang:Set("tool.drgbase_tool_damage.false", "Non")
  ...
  lang:Set("tool.drgbase_tool_damage.dmg_burn", "Brulûre")
  lang:Set("tool.drgbase_tool_damage.dmg_slowburn", "Brulûre lente")
  lang:Set("tool.drgbase_tool_damage.dmg_shock", "Electricité")
  lang:Set("tool.drgbase_tool_damage.dmg_plasma", "Plasma")
  lang:Set("tool.drgbase_tool_damage.dmg_dissolve", "Dissoudre")
  lang:Set("tool.drgbase_tool_damage.dmg_sonic", "Sonore")
